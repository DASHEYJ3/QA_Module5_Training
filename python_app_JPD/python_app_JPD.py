...
book_df = pd.read_csv(r"C:\Users\Admin\Desktop\QA_Module5_Training\python_app_JPD\DATA\03_Library Systembook.csv",quotechar='"')

# DataFrame - read the Customers file
customerid_df = pd.read_csv(r"C:\Users\Admin\Desktop\QA_Module5_Training\python_app_JPD\DATA\03_Library SystemCustomers.csv")
...
# Export to CSV
new_book_df.to_csv(r'C:\Users\Admin\Desktop\QA_Module5_Training\python_app_JPD\DATA\cleaned_books.csv', index=False)  # Set index=False to exclude the index column
...
errors_df = book_df[book_df['Book checkout'].isna()]
errors_df.to_csv(r'C:\Users\Admin\Desktop\QA_Module5_Training\python_app_JPD\DATA\invalid_books.csv', index=False)  # Set index=False to exclude the index column
...
new_customer_df.to_csv(r'C:\Users\Admin\Desktop\QA_Module5_Training\python_app_JPD\DATA\cleaned_customers.csv', index=False)  # Set index=False to exclude the index column
