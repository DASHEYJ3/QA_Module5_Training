...
# Export to CSV
new_book_df.to_csv(r'C:\Users\Admin\Desktop\QA_Module5_Training\python_app\DATA\cleaned_books1.csv', index=False)  # Set index=False to exclude the index column
...
errors_df = book_df[book_df['Book checkout'].isna()]
errors_df.to_csv(r'C:\Users\Admin\Desktop\QA_Module5_Training\python_app\DATA\invalid_books1.csv', index=False)  # Set index=False to exclude the index column
...
new_customer_df.to_csv(r'C:\Users\Admin\Desktop\QA_Module5_Training\python_app\DATA\cleaned_customers1.csv', index=False)  # Set index=False to exclude the index column
